...
import { replayDeltaLabel } from "../replay/labels";
import { DesktopReplayTransport } from "../replay/ReplayControls";
import { SegButton, Segmented } from "../ui/Segmented";
import { Tooltip } from "../ui/Tooltip";
import { formatReplayClockLabel, formatTopbarClock } from "./clock";
...
function formatReplayClock(
  ...
  return formatReplayClockLabel(playheadMs, clockMode, rangeMs, pastWindow);
}
